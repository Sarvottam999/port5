    ...
    <nav className="  p-2">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between   items-center">
          <Link  to="/port5/" className="text-black font-semibold text-[3rem]">Skos<span className="text-blue-600">.</span></Link>
          ...
          <div className="flex space-x-8 mr-10">
            ...
            {/* twitter */}
            <span className="me-2 [&>svg]:h-5 [&>svg]:w-5 hover:bg-black p-2 rounded-full hover:[&>svg]:fill-[#fcfcfc] [&>svg]:fill-[#101010] bg-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 512 512"
            ...
            {/* <!-- Instagram --> */}
            {/* <span className="[&>svg]:h-5 [&>svg]:w-5  bg-black p-1   rounded-full [&>svg]:fill-[#fcfcfc]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 448 512"
